...
game_parameters = {
    ...
    'cols': 15,
    'atlas': 'atlas.jpg',
    'atlas_transparent': 'atlas_transparent.jpg',
    'players': ['ego', 'alter'],
    ...
    'n_doors_per_row': 3,
    'door_types': ['red', 'blue'],
    'use_fixed_falling_door_interval': False,
    ...
    },
    {
    ...
    },
     {
        ...
        'doors':      [{'time': 2, 'color': 'red', 'player': 'alter', 'active': True},
                       {'time': 7, 'color': 'red', 'player': 'alter', 'active': False},
                       {'time': 11, 'color': 'blue', 'player': 'ego', 'active': True},
                       {'time': 16, 'color': 'blue', 'player': 'ego', 'active': False},
                       {'time': 21, 'color': 'blue', 'player': 'alter', 'active': False},
                       {'time': 26, 'color': 'red', 'player': 'alter', 'active': True}],
        'keys':       {'ego': ['blue', 'red'], 'alter': ['blue', 'red']},
        'help_other': 'no_help_needed'
    },
    {
    ...
    },
{
        ...
        'doors':      [{'time': 3, 'color': 'red', 'player': 'ego', 'active': True},
                       ...
                       {'time': 32, 'color': 'red', 'player': 'ego', 'active': True},
                       {'time': 36, 'color': 'red', 'player': 'ego', 'active': False}],
        'keys':       {'ego': ['blue', 'red'], 'alter': ['blue', 'red']},
        'help_other': 'tit_for_tat'
    },
{
        ...
        'doors':      [{'time': 2, 'color': 'blue', 'player': 'alter', 'active': True},
                       ...
                       {'time': 35, 'color': 'red', 'player': 'ego', 'active': False},
                       {'time': 38, 'color': 'blue', 'player': 'ego', 'active': True}],
        'keys':       {'ego': ['blue', 'red'], 'alter': ['blue', 'red']},
        'help_other': 'tit_for_tat'
    },
{
    ...
    },
{
        ...
        'doors':      [{'time': 4, 'color': 'blue', 'player': 'ego', 'active': True},
                       {'time': 13, 'color': 'red', 'player': 'alter', 'active': True},
                       {'time': 22, 'color': 'red', 'player': 'alter', 'active': True},
                       {'time': 29, 'color': 'blue', 'player': 'ego', 'active': True},
                       {'time': 34, 'color': 'red', 'player': 'ego', 'active': False},
                       {'time': 38, 'color': 'red', 'player': 'ego', 'active': True}],
        'keys':       {'ego': ['blue', 'red'], 'alter': ['blue', 'red']},
        'help_other': 'tit_for_tat'
    },
    {
    ...
    },
{
        ...
        'doors':      [{'time': 3, 'color': 'blue', 'player': 'alter', 'active': True},
                       ...
                       {'time': 27, 'color': 'red', 'player': 'ego', 'active': False},
    ...
    },
{
        'type':       'baseline', # 6
        'doors':      [{'time': 3, 'color': 'red', 'player': 'alter', 'active': True},
                       {'time': 6, 'color': 'red', 'player': 'ego', 'active': False},
                       {'time': 11, 'color': 'red', 'player': 'alter', 'active': False},
                       {'time': 16, 'color': 'red', 'player': 'ego', 'active': False},
                       {'time': 20, 'color': 'red', 'player': 'alter', 'active': True},
                       {'time': 28, 'color': 'red', 'player': 'ego', 'active': True}],
        'keys':       {'ego': ['blue', 'red'], 'alter': ['blue', 'red']},
        'help_other': 'dies_if_helped'
    },
{
        ...
        'doors':      [{'time': 2, 'color': 'blue', 'player': 'ego', 'active': False},
                       ...
                       {'time': 21, 'color': 'red', 'player': 'alter', 'active': True},
                       {'time': 29, 'color': 'red', 'player': 'ego', 'active': True}],
        'keys':       {'ego': ['blue', 'red'], 'alter': ['blue', 'red']},
        'help_other': 'dies_if_helped'
    },
{
        ...
        'doors':      [{'time': 4, 'color': 'red', 'player': 'ego', 'active': False},
                       {'time': 7, 'color': 'blue', 'player': 'alter', 'active': True},
                       {'time': 11, 'color': 'blue', 'player': 'alter', 'active': False},
                       {'time': 15, 'color': 'blue', 'player': 'alter', 'active': True},
                       {'time': 23, 'color': 'blue', 'player': 'ego', 'active': True},
                       {'time': 28, 'color': 'blue', 'player': 'ego', 'active': False}],
        'keys':       {'ego': ['blue', 'red'], 'alter': ['blue', 'red']},
        'help_other': 'dies_if_helped'
    },
    {
        ...
        'doors':      [{'time': 3, 'color': 'blue', 'player': 'alter', 'active': True},
                       ...
                       {'time': 16, 'color': 'blue', 'player': 'alter', 'active': False},
                       {'time': 20, 'color': 'blue', 'player': 'alter', 'active': True},
