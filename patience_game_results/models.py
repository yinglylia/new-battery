...
class Constants(BaseConstants):
    name_in_url = 'boat_results'
    players_per_group = None
    num_rounds = 1

    comments = [
        'Where the instructions clear enough? If not,  where did you struggle?',
        'Did you find the practice round helpful? Would you have needed more or less practice?',
        'What do you think the game was about?',
        'Did everything work well? Did you experience and technical problems?',
